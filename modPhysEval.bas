...
Public Sub BuildROM_Trunk(host As MSForms.Frame)
    ...
    ' 頸部
    y = BuildRomSingleJointBlock(host, "Trunk", "Neck", "頸部", "Flex", "屈曲", y)
    y = BuildRomSingleJointBlock(host, "Trunk", "Neck", "頸部", "Ext", "伸展", y)
    y = BuildRomJointBlock(host, "Trunk", "Neck", "頸部", Split("Rot,LatFlex", ","), y)
    y = y + ROM_JOINT_GAP_Y

    ' 体幹
    y = BuildRomSingleJointBlock(host, "Trunk", "Trunk", "体幹", "Flex", "屈曲", y)
    y = BuildRomSingleJointBlock(host, "Trunk", "Trunk", "体幹", "Ext", "伸展", y)
    y = BuildRomJointBlock(host, "Trunk", "Trunk", "体幹", Split("Rot,LatFlex", ","), y)
    y = y + ROM_JOINT_GAP_Y
