...
RecalcBI
  ...
  Dim fBasic As MSForms.Frame: Set fBasic = CreateFrameP(hostBasic, "基本情報", 360)
   ...
   ' s5Fpj
    ...
    Set wkMon = EnsureCheckBox(fBasic, "月", useDayLeft + useDayGap * 0, y, "chkUseMon", "Basic.UseWeekday.Mon")
    Set wkTue = EnsureCheckBox(fBasic, "火", useDayLeft + useDayGap * 1, y, "chkUseTue", "Basic.UseWeekday.Tue")
    Set wkWed = EnsureCheckBox(fBasic, "水", useDayLeft + useDayGap * 2, y, "chkUseWed", "Basic.UseWeekday.Wed")
    Set wkThu = EnsureCheckBox(fBasic, "木", useDayLeft + useDayGap * 3, y, "chkUseThu", "Basic.UseWeekday.Thu")
    Set wkFri = EnsureCheckBox(fBasic, "金", useDayLeft + useDayGap * 4, y, "chkUseFri", "Basic.UseWeekday.Fri")
    Set wkSat = EnsureCheckBox(fBasic, "土", useDayLeft + useDayGap * 5, y, "chkUseSat", "Basic.UseWeekday.Sat")
    nL y
